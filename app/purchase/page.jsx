...
//   const SHEET_ID = "1t6ptKNYkmWTA-_HYJ6KrjYdx91kVMFZPM7YGtyxJRHM";
...
//   //   if (!searchTerm) return purchaseData;
...
//         const scriptUrl =
//           "https://script.google.com/macros/s/AKfycbxWGfMGnpHU3mRkKbeodwn1p64zBFGlQlpKXrztw3xWvr5_GPtQgdYurKLDWBCOtJxu/exec";
...
//                   setCurrentPage(1);
//                 }}
//                 className="px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-violet-500 bg-white min-w-[250px]"
//               >
...
//                             <p className="text-sm">{item.personName || "-"}</p>
//                             {item.contactNo && (
//                               <a
...
//                             Delivery: {renderCellContent(item, "deliveryDate")}
//                           </div>
//                         )}
//                       </div>
//                     </div>
